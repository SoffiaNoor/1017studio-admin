    ...
    <div class="row">
        <div class="col-lg-12 mb-lg-0 mb-4 shadow-xl">
            <div class="card p-2">
                ...
                @endif
                <form class="p-3" method="POST" action="{{ route('faq.store')}}" enctype="multipart/form-data">
                    @csrf
                    @if ($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" style="height:300px" class="form-control" id="question" name="question"
                                    required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea type="text" style="height:300px" class="form-control" id="answer" name="answer"
                                    required></textarea>
                            </div>
                        </div>
                    </div>
